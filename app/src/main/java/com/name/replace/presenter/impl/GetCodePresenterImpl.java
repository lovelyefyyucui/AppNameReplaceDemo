...
public class GetCodePresenterImpl implements GetCodePresenter {
    ...
    public GetCodePresenterImpl(BaseDataView mBaseDataView, String mTag) {
        this.mBaseDataView = mBaseDataView;
        this.mTag = mTag;
        mGetCodeModel = new GetCodeModel();
    }
...
//        mBaseDataView.showLoading();
        mGetCodeModel.getCode(map, new HttpCallBack<BaseModel<Object>>(){
            @Override
