...
public class XRecyclerView extends FrameLayout implements SwipyRefreshLayout.OnRefreshListener{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mSwipyRefreshLayout.setColorSchemeResources(R.color.lawngreen, R.color.darkgray, R.color.bottom_red_press);
        ...
        RecyclerViewOrientation orientation = RecyclerViewOrientation.getFromInt(mTypedArray.getInt(R.styleable.XRecyclerView_orientation, 0));
        if (orientation == RecyclerViewOrientation.VERTICAL)
        {
            mRecyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false));
        } else if (orientation == RecyclerViewOrientation.HORIZONTAL)
        {
            mRecyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        } else {
            int count = mTypedArray.getInt(R.styleable.XRecyclerView_count, 2);
